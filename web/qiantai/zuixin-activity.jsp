...
<div class="content">
    ...
    <div class="breadcrumbs breadcrumbs-b"><i class="icon-home-2"></i><a href="">首页</a>>><a href="">最新活动</a></div>
    <!--最新商品 start-->
    <div class="jxproject">
        <div class="tit new-tit"><span>活动专区</span></div>
        <img src="images/xwxq1.png" alt="" class="hdzq-pic"/>
        <div class="t-piclist hongd-list">
            <ul>
                <li>
                    <span class="sy-icon"></span>
                    <div class="img"><img src="images/zxhd.png" alt=""/></div>
                    <div class="con">
                        <div class="txt">Apple iphone6s 16G 颜色随机</div>
                        <span><i class="icon-clock"></i> 2016-3-25 18:21</span>
                        <p>记得当时年纪小你爱谈天我爱笑有一回坐在桃树下风在林
                            稍鸟儿在叫不知怎样你睡着了梦里花落知多少……</p>
                        <a href="">查看全文</a>
                    </div>
                </li>
                <li>
