...
<div class="content content1">
    ...
    <div class="xzshdz-b" style="height: auto;">
        <div class="gmjl-cl"></div>
        <h3 class="zt-h3">当前状态：确认收货地址</h3>
        <h3 class="gwc-tit" style="font-size: 14px;color:#db3652;font-weight: normal;width: 1130px;margin: 20px auto;">已保存的有效收货地址</h3>
        <table class="cart-table" style="width: 1130px;">
            <thead>
            <tr>
                <th width="25%">收货人</th>
                <th width="25%">收货地址</th>
            ...
            <tbody>
            <tr class="active">
                <td><input type="checkbox" checked/>张某</td>
                <td><p>广东省 深圳市 南山区 <br/>
                    科技园科丰路特发信息港A栋北5楼</p>
                </td>
                <td class="jiazhi">18666666666</td>
                <td class="caozuo">
                    <em>默认地址</em>
        ...
        <div class="foot" style="width: 1130px;margin: 0 auto;background: #fff;border: 0;">
            <div class="fr total" style="line-height: 40px;width: 160px;text-align: right;margin: 20px 0 40px 0">
                <a id="btn-12" href="" class="">确认收货地址</a>
            </div>
        </div>
    </div>
