...
<div class="content content1">
    ...
    <div class="ddjx-box" style="border-top: 2px solid #ff3a1a;">
        <h3 class="gwc-tit" style="font-size: 22px;">微信支付</h3>
        <div class="smrwm-b">
            扫一扫付款 <br/>
            <i>￥45</i>
            <img src="images/wxzf_06.png" alt=""/>
            <img class="wxbtn" src="images/wxbtn.png" alt="" style="margin-top: 20px;"/>
        </div>
    </div>
</div>
<div class="footer">
