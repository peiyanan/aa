...
<div class="content content1">
    ...
    <div class="xzshdz-b" style="height: auto;">
        <div class="gmjl-cl2"></div>
        <h3 class="zt-h3">当前状态：待付款  <button>立即付款</button><br/>
            <span>请在  <i>00小时12分27秒</i>  内进行付款，若未及时付款，系统将自动关闭订单</span>
        </h3>
        <div style="width: 1130px;margin: 0 auto 40px auto;" class="hhxxb">
            <b>订单信息</b>
            <p><i>收货地址：</i>张三  18688886666  广东省 深圳市 南山区 科技园科丰路特发信息港A栋北5楼 <br/>
                <i>订单号：</i>218539 <br/>
                <i>下单时间：</i>2016-05-12  15:36:45 <br/>
                <i>订单金额：</i> <em>￥45.00</em> <a class="fkxq1">付款详情 <span class="icon-down-open"></span></a><br/>
            </p>
            <p class="fkxqp"><i>商品金额：</i><em>￥45.00</em>      运费：<em>￥0.00</em>（包邮）   红包抵扣：<em>￥0.00</em>   其他优惠：<em>￥0.00</em> <br/>
               <i> 应付金额：</i><em>￥35.00</em> <br/>
                <i>付款时间：</i>尚未支付 <br/>
            </p>
        </div>
    </div>
