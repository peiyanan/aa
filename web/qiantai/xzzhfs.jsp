...
<div class="content">
    <div class="con3">
        ...
        <div class="zhmm-form1" style="margin-left: 280px">
            <form action="">
                <div>
                    <p class="wt"><span id="sj-icon"><i class="icon-mobile"></i></span> <a href="">通过手机</a> <span id="sj-icon1"><i class="icon-lock-filled"></i></span> <a href="">通过密保问题</a></p>
                </div>
            </form>
        </div>
    </div>
