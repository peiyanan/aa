...
<div class="content content1">
    ...
    <div class="ddjx-box">
        <div class="ddjx-b ddjx-b1">
            <h4><i class="icon-ok-circled2"></i><span>订单提交成功，</span>只差最后一步支付就可以啦！</h4>
            <p>请您在提交订单后 <i>00小时29分53秒</i>完成支付，否则订单会自动取消！</p>
        </div>
        <p class="dingdanhao">订单号：<i>2016042909210912910</i></p>
        <table class="cart-table">
        <tbody>
        <tr>
            <td width="10%" style="text-align: center"><img src="images/sy_07.png" alt="" style="float: none;"/></td>
            <td width="30%"><h4>Apple iPhone6s Plus 128G 颜色随机</h4></td>
            <td width="10%">304290739</td>
            <td width="10%" class="jiazhi">4988</td>
            <td width="10%" class="price">1</td>
            <td width="10%">1</td>
            <td width="10%">1</td>
            <td width="10%" class="xiaoji">5</td>
        </tr>
        <tr>
            <td width="10%" style="text-align: center"><img src="images/sy_07.png" alt="" style="float: none;"/></td>
            <td width="30%"><h4>Apple iPhone6s Plus 128G 颜色随机</h4></td>
        ...
        <tr>
            <td colspan="8" class="lasttd2"><span class="pro-hj">商品合计：<i>￥20</i></span><a href="" class="r">返回清单修改</a></td>
        </tr>
        <tr>
            <td colspan="8" class="lasttd1"><span class="zhifubox">
                <p>
                    <span class="hbjxze"><input type="checkbox"/>使用红包抵消部分总额</span>
                    <select name="" id="" class="selectpicker r" data-width="240">
                    <option value="暂无可用红包">暂无可用红包</option>
                    <option value="暂无可用红包">暂无可用红包</option>
                    <option value="暂无可用红包">暂无可用红包</option>
                </select>
                    </p>
                    <span class="jjgg">
                    <h5>红包折扣：<i class="r">-￥0.00</i></h5>
                    <h5>总需支付：<i class="r">￥20.00</i></h5>
                </span>
                <div style="width:430px;overflow: hidden;"><a id="btn-10" href="" class="r" style="margin-right: 0">去支付</a></div>
            </span></td>
        </tr>
        </tbody>
        </table>
