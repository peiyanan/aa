...
<div class="content">
    ...
    <div class="breadcrumbs breadcrumbs-b"><i class="icon-home-2"></i><a href="">首页</a>>><a href="">十元专区</a></div>
    <!--最新商品 start-->
    <div class="jxproject">
        <div class="tit"><span>所有商品</span></div>
        <div class="t-piclist piclist10">
            <ul>
                <li>
        ...
        <div class="sy-rig">
            <div class="tit">十元专区  规则说明</div>
            <div class="box">“十元专区”是指每次参与，人次必须是 <i>十的倍数</i>； <br/><br/>
                十元专区分配的号码非连号，亦是随机分配；<br/><br/>
                幸运号码计算规则与一元夺宝商品相同。
            </div>
        </div>
    </div>
