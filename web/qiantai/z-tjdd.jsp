...
<div class="content content1">
    <div class="cart-tit">我的购物车
        <div class="jddd jddd1"></div>
    </div>
    <div class="xzshdz-b">
        <h3 class="gwc-tit">确认收货地址</h3>
        <ul>
            <li> <div class="tit">张三 <a>默认地址</a></div>
                 <div class="con">广东省  深圳市  南山区 <br/>
                     科技园科丰路特发信息港A栋北5楼 <br/>
                     <p>18688886666</p>
                     <a href="">修改</a><a href="">删除</a>
                 </div>

                <span class="xiaojiao"></span>
            </li>
            <a href="" class="add-shdz">+ 添加收货地址</a>
        </ul>
    </div>
    <h3 class="gwc-tit">确认订单信息</h3>
    ...
    <div class="catbox">
        <table id="cartTable" class="cart-table">
            ...
            <tr>
                ...
                <td class="count"style="padding-left: 70px;"><span class="reduce" onclick="javascript:void(0);">-</span>
                    <input class="count-input" type="text" value="1" disabled="true"/>
                    <span class="add" onclick="javascript:void(0);">+</span></td>
                <td class="subtotal">45.00</td>
            </tr>
            <tr>
                <td class="goods" style="padding-left: 60px;"><img src="images/sy_07.png" alt=""/> <h4>Apple iPhone6s Plus 128G 颜色随机</h4>
                    <p>总需<i>4998</i>人次参与，还剩：3814人次</p></td>
        ...
        <div class="foot" id="foot" style="height: 200px;">
            <div class="fr total" style="line-height: 40px;width: 160px;text-align: right">
                商品金额：<span>￥45</span> <br/>
                实付款：￥<span id="priceTotal">45</span> <br/><br/>
                <a id="btn-12" href="" class="">提交订单</a>
            </div>
        </div>
    </div>
</div>
