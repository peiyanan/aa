...
<div class="content content1">
    ...
    <div class="ddjx-box">
        <div class="ddygq-b"> <i class="icon-cancel-circled"></i>Sorry！夺宝失败！<br/>
            <p>您现在可以 <a href="">查看夺宝记录</a> 其他商品 <br/>
                总共有 <em>1件</em> 商品参与夺宝失败，信息如下：</p>

            <table class="shdz-tab" style="width: 960px;height: 100px;margin: 70px auto;border:1px solid #dcdcdc">
                <thead>
                <tr>
                    <td width="100%">以下商品参与夺宝失败</td>
                </tr>
                </thead>
                <tbody>
                <tr>
                    <td style="text-align: left;padding-left: 40px;">裕昌食品 鸭胗120g*2包 香辣鸭肫 鸭肫肝 真空小包装 <br/>
                        商品期号：305122592</td>
                </tr>
                </tbody>
            </table>
