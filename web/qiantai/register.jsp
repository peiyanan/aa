    ...
    <div class="con3 register">
        ...
        <div class="dl-form">
            <form action="">
                <div>
                    <b>账号：</b>
                    <p><input type="text" placeholder="手机号/邮箱"/>
                    </p>
                </div>
                <div>
                    <b>密码：</b>
                    <p><input type="password" placeholder="6-16位密码，区分大小写" name="new-pass"/></p>
                </div>
                <div>
                    <b>确认密码：</b>
                    <p><input type="password" placeholder="再次数入密码" name="new-pass"/></p>
                </div>
                <div>
                    <b>验证码：</b>
                    <p class="yzm">
                        <span class="ww100">
                        <input type="text" placeholder="请输入验证码" class="yzm l"/>
                        <img src="images/yzm.png" alt=""/>
                        <a href="" class="r" style="margin:0 0 0 10px;">换一张</a></span>
                    </p>
                </div>
                <div>
                    <b>手机号：</b>
                ...
                <div>
                    <b>短信验证码：</b>
                    <p class="yzm"><input type="text" placeholder="请输入短信验证码" class="yzm"/>
